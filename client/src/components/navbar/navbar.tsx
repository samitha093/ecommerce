    ...
    <ul className="flex bg-lightblue-300 w-screen h-12 items-center px-4">
      ...
      <li className="mr-6">
        <span style={{ display: 'inline-flex', alignItems: 'center' }}>
          ...
          <Link style={{ color: 'blue', textDecoration: 'none', marginLeft: '0.5rem' }} to="/">
            Home
          </Link>
        </span>
      </li>
      ...
      <li className="mr-6">
        <span style={{ display: 'inline-flex', alignItems: 'center' }}>
          ...
          <Link className="text-blue-500 hover:text-blue-800" to="/productImageUpload">
          Image Upload
        </Link>
        </span>
      </li>
      <li className="mr-6">
        <span style={{ display: 'inline-flex', alignItems: 'center' }}>
          ...
          <Link className="text-blue-500 hover:text-blue-800" to="/categoryUpload">
          Category upload
        </Link>
        </span>
      </li>
